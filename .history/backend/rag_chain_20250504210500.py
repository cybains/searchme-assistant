...
MODEL_NAME = 'gpt-2'  # Change to your desired Hugging Face model (e.g., 'gpt-2', 'distilgpt2', etc.)
...
def generate_response(query, documents):
    ...
    # Tokenize input text and ensure that the model can process it within its token limit
    inputs = tokenizer(context + query, return_tensors='pt', truncation=True, max_length=1024)
