...
DATA_FOLDER = os.path.join(os.path.dirname(__file__), "../data/")  # Resolves relative to the script's locationVECTORSTORE_PATH = "vectorstore/faiss.index"  # Path to your FAISS index
