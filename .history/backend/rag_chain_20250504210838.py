...
def retrieve_documents(query, top_k=3):  # Limit to top 3 documents
    ...
    for idx in indices[0]:
        filename = os.listdir(DATA_FOLDER)[idx]  # Get the document filename
...
def generate_response(query, documents):
    ...
    # Ensure context + query does not exceed model input length
