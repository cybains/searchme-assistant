...
def format_prompt(context_docs, user_query):
    ...
    prompt = f"""
You are a helpful assistant specialized in Portuguese immigration law. The user will ask questions and your job is to provide clear and detailed answers based on the context provided. All the answ
